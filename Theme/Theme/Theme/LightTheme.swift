...
class LightThemeColor: ThemeColor {
    public static var Border: ThemeColorBorder.Type = LightThemeColorBorder.self
    public static var Background: ThemeColorBackground.Type = LightThemeColorBackground.self
    public static var Text: ThemeColorText.Type = LightThemeColorText.self
...
class LightThemeColorText: ThemeColorText {
...
class LightThemeColorBackground: ThemeColorBackground {
    public class var white: UIColor {
        return UIColor.white
    }
...
class LightThemeColorBorder: ThemeColorBorder {
